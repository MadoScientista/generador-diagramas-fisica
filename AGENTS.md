...
- **Label style:** Inter (Roboto fallback), sans-serif, no italic. **Exception:** el generador de plano cartesiano usa IBM Plex Mono (`--plano-mono`) en los números del plano, etiquetas de unidad y título de su tarjeta — no es un diagrama de física.
